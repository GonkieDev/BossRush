/*
// NOTE(gsp): Some changes were made by me, ill leave a note with the tag 
//            @hmm_math where those changes were made

  HandmadeMath.h v2.0.0

  This is a single header file with a bunch of useful types and inline_functions for
  ...
  Regardless of the default angle, you can use the following inline_functions to
  ...
  The definitions of these inline_functions change depending on the default unit.
  ...
  implementations of basic math inline_functions. Otherwise, HandmadeMath.h will use
  the runtime library implementation of these inline_functions.
  ...
  By default, it is assumed that your math inline_functions take radians. To use
  ...
  code but your math inline_functions use turns:
...
#define HMM_RadToDeg ((f32)(HMM_DEG180/HMM_PI))
#define HMM_RadToTurn ((f32)(HMM_TURNHALF/HMM_PI))
#define HMM_DegToRad ((f32)(HMM_PI/HMM_DEG180))
#define HMM_DegToTurn ((f32)(HMM_TURNHALF/HMM_DEG180))
#define HMM_TurnToRad ((f32)(HMM_PI/HMM_TURNHALF))
#define HMM_TurnToDeg ((f32)(HMM_DEG180/HMM_TURNHALF))
...
#define HMM_SQUARE(x) ((x) * (x))
 ...
 typedef union HMM_Vec2
 {
  ...
  // NOTE(gsp): @hmm_math changed to lower case
  struct
  {
   f32 x, y;
  };
 ...
 typedef union HMM_Vec3
 {
  ...
  // NOTE(gsp): @hmm_math changed to lowercase
  struct
  {
   f32 x, y, z;
  };
 ...
 typedef i32 HMM_Bool;
 
 /*
  * Angle unit conversion inline_functions
  */
 inline_function f32 HMM_ToRad(f32 Angle)
 {
#if defined(HANDMADE_MATH_USE_RADIANS)
  f32 Result = Angle;
#elif defined(HANDMADE_MATH_USE_DEGREES)
  f32 Result = Angle * HMM_DegToRad;
#elif defined(HANDMADE_MATH_USE_TURNS)
  f32 Result = Angle * HMM_TurnToRad;
#endif
  
  return Result;
 }
 
 inline_function f32 HMM_ToDeg(f32 Angle)
 {
#if defined(HANDMADE_MATH_USE_RADIANS)
  f32 Result = Angle * HMM_RadToDeg;
#elif defined(HANDMADE_MATH_USE_DEGREES)
  f32 Result = Angle;
#elif defined(HANDMADE_MATH_USE_TURNS)
  f32 Result = Angle * HMM_TurnToDeg;
#endif
  
  return Result;
 }
 
 inline_function f32 HMM_ToTurn(f32 Angle)
 {
#if defined(HANDMADE_MATH_USE_RADIANS)
  f32 Result = Angle * HMM_RadToTurn;
#elif defined(HANDMADE_MATH_USE_DEGREES)
  f32 Result = Angle * HMM_DegToTurn;
#elif defined(HANDMADE_MATH_USE_TURNS)
  f32 Result = Angle;
#endif
 ...
 /*
  * Floating-point math inline_functions
  */
 
 COVERAGE(HMM_SinF, 1)
  inline_function f32 HMM_SinF(f32 Angle)
 {
 ...
 COVERAGE(HMM_CosF, 1)
  inline_function f32 HMM_CosF(f32 Angle)
 {
 ...
 COVERAGE(HMM_TanF, 1)
  inline_function f32 HMM_TanF(f32 Angle)
 {
 ...
 COVERAGE(HMM_ACosF, 1)
  inline_function f32 HMM_ACosF(f32 Arg)
 {
 ...
 COVERAGE(HMM_SqrtF, 1)
  inline_function f32 HMM_SqrtF(f32 Float)
 {
  ...
  f3232x4_t In = vdupq_n_f32(Float);
 ...
 COVERAGE(HMM_InvSqrtF, 1)
  inline_function f32 HMM_InvSqrtF(f32 Float)
 {
 ...
 /*
  * Utility inline_functions
  */
 
 COVERAGE(HMM_Lerp, 1)
  inline_function f32 HMM_Lerp(f32 A, f32 Time, f32 B)
 {
 ...
 COVERAGE(HMM_Clamp, 1)
  inline_function f32 HMM_Clamp(f32 Min, f32 Value, f32 Max)
 {
 ...
 COVERAGE(HMM_V2, 1)
  inline_function HMM_Vec2 HMM_V2(f32 X, f32 Y)
 {
 ...
 COVERAGE(HMM_V3, 1)
  inline_function HMM_Vec3 HMM_V3(f32 X, f32 Y, f32 Z)
 {
 ...
 COVERAGE(HMM_V4, 1)
  inline_function HMM_Vec4 HMM_V4(f32 X, f32 Y, f32 Z, f32 W)
 {
 ...
 COVERAGE(HMM_V4V, 1)
  inline_function HMM_Vec4 HMM_V4V(HMM_Vec3 Vector, f32 W)
 {
...
#elif defined(HANDMADE_MATH__USE_NEON)
  f3232x4_t v = {Vector.X, Vector.Y, Vector.Z, W};
  Result.NEON = v;
#else
  Result.XYZ = Vector;
  Result.W = W;
 ...
 COVERAGE(HMM_AddV2, 1)
  inline_function HMM_Vec2 HMM_AddV2(HMM_Vec2 Left, HMM_Vec2 Right)
 {
 ...
 COVERAGE(HMM_AddV3, 1)
  inline_function HMM_Vec3 HMM_AddV3(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_AddV4, 1)
  inline_function HMM_Vec4 HMM_AddV4(HMM_Vec4 Left, HMM_Vec4 Right)
 {
 ...
 COVERAGE(HMM_SubV2, 1)
  inline_function HMM_Vec2 HMM_SubV2(HMM_Vec2 Left, HMM_Vec2 Right)
 {
 ...
 COVERAGE(HMM_SubV3, 1)
  inline_function HMM_Vec3 HMM_SubV3(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_SubV4, 1)
  inline_function HMM_Vec4 HMM_SubV4(HMM_Vec4 Left, HMM_Vec4 Right)
 {
 ...
 COVERAGE(HMM_MulV2, 1)
  inline_function HMM_Vec2 HMM_MulV2(HMM_Vec2 Left, HMM_Vec2 Right)
 {
 ...
 COVERAGE(HMM_MulV2F, 1)
  inline_function HMM_Vec2 HMM_MulV2F(HMM_Vec2 Left, f32 Right)
 {
 ...
 COVERAGE(HMM_MulV3, 1)
  inline_function HMM_Vec3 HMM_MulV3(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_MulV3F, 1)
  inline_function HMM_Vec3 HMM_MulV3F(HMM_Vec3 Left, f32 Right)
 {
 ...
 COVERAGE(HMM_MulV4, 1)
  inline_function HMM_Vec4 HMM_MulV4(HMM_Vec4 Left, HMM_Vec4 Right)
 {
 ...
 COVERAGE(HMM_MulV4F, 1)
  inline_function HMM_Vec4 HMM_MulV4F(HMM_Vec4 Left, f32 Right)
 {
 ...
 COVERAGE(HMM_DivV2, 1)
  inline_function HMM_Vec2 HMM_DivV2(HMM_Vec2 Left, HMM_Vec2 Right)
 {
 ...
 COVERAGE(HMM_DivV2F, 1)
  inline_function HMM_Vec2 HMM_DivV2F(HMM_Vec2 Left, f32 Right)
 {
 ...
 COVERAGE(HMM_DivFV2, 1)
  inline_function HMM_Vec2 HMM_DivFV2(f32 Left, HMM_Vec2 Right)
 {
  ASSERT_COVERED(HMM_DivFV2);
 ...
 COVERAGE(HMM_DivV3, 1)
  inline_function HMM_Vec3 HMM_DivV3(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_DivV3F, 1)
  inline_function HMM_Vec3 HMM_DivV3F(HMM_Vec3 Left, f32 Right)
 {
 ...
 COVERAGE(HMM_DivV4, 1)
  inline_function HMM_Vec4 HMM_DivV4(HMM_Vec4 Left, HMM_Vec4 Right)
 {
 ...
 COVERAGE(HMM_DivV4F, 1)
  inline_function HMM_Vec4 HMM_DivV4F(HMM_Vec4 Left, f32 Right)
 {
...
#elif defined(HANDMADE_MATH__USE_NEON)
  f3232x4_t Scalar = vdupq_n_f32(Right);
 ...
 COVERAGE(HMM_EqV2, 1)
  inline_function HMM_Bool HMM_EqV2(HMM_Vec2 Left, HMM_Vec2 Right)
 {
 ...
 COVERAGE(HMM_EqV3, 1)
  inline_function HMM_Bool HMM_EqV3(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_EqV4, 1)
  inline_function HMM_Bool HMM_EqV4(HMM_Vec4 Left, HMM_Vec4 Right)
 {
 ...
 COVERAGE(HMM_DotV2, 1)
  inline_function f32 HMM_DotV2(HMM_Vec2 Left, HMM_Vec2 Right)
 {
 ...
 COVERAGE(HMM_DotV3, 1)
  inline_function f32 HMM_DotV3(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_DotV4, 1)
  inline_function f32 HMM_DotV4(HMM_Vec4 Left, HMM_Vec4 Right)
 {
...
#elif defined(HANDMADE_MATH__USE_NEON)
  f3232x4_t NEONMultiplyResult = vmulq_f32(Left.NEON, Right.NEON);
 ...
 COVERAGE(HMM_Cross, 1)
  inline_function HMM_Vec3 HMM_Cross(HMM_Vec3 Left, HMM_Vec3 Right)
 {
 ...
 COVERAGE(HMM_LenSqrV2, 1)
  inline_function f32 HMM_LenSqrV2(HMM_Vec2 A)
 {
 ...
 COVERAGE(HMM_LenSqrV3, 1)
  inline_function f32 HMM_LenSqrV3(HMM_Vec3 A)
 {
 ...
 COVERAGE(HMM_LenSqrV4, 1)
  inline_function f32 HMM_LenSqrV4(HMM_Vec4 A)
 {
 ...
 COVERAGE(HMM_LenV2, 1)
  inline_function f32 HMM_LenV2(HMM_Vec2 A)
 {
 ...
 COVERAGE(HMM_LenV3, 1)
  inline_function f32 HMM_LenV3(HMM_Vec3 A)
 {
 ...
 COVERAGE(HMM_LenV4, 1)
  inline_function f32 HMM_LenV4(HMM_Vec4 A)
 {
 ...
 COVERAGE(HMM_NormV2, 1)
  inline_function HMM_Vec2 HMM_NormV2(HMM_Vec2 A)
 {
 ...
 COVERAGE(HMM_NormV3, 1)
  inline_function HMM_Vec3 HMM_NormV3(HMM_Vec3 A)
 {
 ...
 COVERAGE(HMM_NormV4, 1)
  inline_function HMM_Vec4 HMM_NormV4(HMM_Vec4 A)
 {
 ...
 /*
  * Utility vector inline_functions
  */
 
 COVERAGE(HMM_LerpV2, 1)
  inline_function HMM_Vec2 HMM_LerpV2(HMM_Vec2 A, f32 Time, HMM_Vec2 B)
 {
 ...
 COVERAGE(HMM_LerpV3, 1)
  inline_function HMM_Vec3 HMM_LerpV3(HMM_Vec3 A, f32 Time, HMM_Vec3 B)
 {
 ...
 COVERAGE(HMM_LerpV4, 1)
  inline_function HMM_Vec4 HMM_LerpV4(HMM_Vec4 A, f32 Time, HMM_Vec4 B)
 {
  ASSERT_COVERED(HMM_LerpV4);
  return HMM_AddV4(HMM_MulV4F(A, 1.0f - Time), HMM_MulV4F(B, Time));
 }
 
 // NOTE(gsp): added Min/Max and Abs
 inline_function HMM_Vec2 HMM_MinV2(HMM_Vec2 a, HMM_Vec2 b)
 {
  HMM_Vec2 Result = HMM_V2(HMM_MIN(a.x, b.x), HMM_MIN(a.y, b.y));
  return Result;
 }
 
 inline_function HMM_Vec2 HMM_MaxV2(HMM_Vec2 a, HMM_Vec2 b)
 {
  HMM_Vec2 Result = HMM_V2(HMM_MAX(a.x, b.x), HMM_MAX(a.y, b.y));
  return Result;
 }
 
 inline_function HMM_Vec2 HMM_AbsV2(HMM_Vec2 v)
 {
  HMM_Vec2 Result = HMM_V2(AbsoluteValueF32(v.x), AbsoluteValueF32(v.y));
  return Result;
 }
 
 // NOTE(gsp): added ternary operations
 /*
*  Ternary vector operations
*/
 
 inline_function HMM_Vec2 HMM_ClampV2(HMM_Vec2 lo, HMM_Vec2 x, HMM_Vec2 hi)
 {
  HMM_Vec2 Result = HMM_MaxV2(lo, HMM_MinV2(x, hi));
  return Result;
 }
 ...
 COVERAGE(HMM_LinearCombineV4M4, 1)
  inline_function HMM_Vec4 HMM_LinearCombineV4M4(HMM_Vec4 Left, HMM_Mat4 Right)
 {
 ...
 COVERAGE(HMM_M2, 1)
  inline_function HMM_Mat2 HMM_M2(void)
 {
 ...
 COVERAGE(HMM_M2D, 1)
  inline_function HMM_Mat2 HMM_M2D(f32 Diagonal)
 {
 ...
 COVERAGE(HMM_TransposeM2, 1)
  inline_function HMM_Mat2 HMM_TransposeM2(HMM_Mat2 Matrix)
 {
 ...
 COVERAGE(HMM_AddM2, 1)
  inline_function HMM_Mat2 HMM_AddM2(HMM_Mat2 Left, HMM_Mat2 Right)
 {
 ...
 COVERAGE(HMM_SubM2, 1)
  inline_function HMM_Mat2 HMM_SubM2(HMM_Mat2 Left, HMM_Mat2 Right)
 {
 ...
 COVERAGE(HMM_MulM2V2, 1)
  inline_function HMM_Vec2 HMM_MulM2V2(HMM_Mat2 Matrix, HMM_Vec2 Vector)
 {
 ...
 COVERAGE(HMM_MulM2, 1)
  inline_function HMM_Mat2 HMM_MulM2(HMM_Mat2 Left, HMM_Mat2 Right)
 {
 ...
 COVERAGE(HMM_MulM2F, 1)
  inline_function HMM_Mat2 HMM_MulM2F(HMM_Mat2 Matrix, f32 Scalar)
 {
 ...
 COVERAGE(HMM_DivM2F, 1)
  inline_function HMM_Mat2 HMM_DivM2F(HMM_Mat2 Matrix, f32 Scalar)
 {
 ...
 COVERAGE(HMM_DeterminantM2, 1)
  inline_function f32 HMM_DeterminantM2(HMM_Mat2 Matrix)
 {
 ...
 COVERAGE(HMM_InvGeneralM2, 1)
  inline_function HMM_Mat2 HMM_InvGeneralM2(HMM_Mat2 Matrix)
 {
  ASSERT_COVERED(HMM_InvGeneralM2);
  
  HMM_Mat2 Result;
  f32 InvDeterminant = 1.0f / HMM_DeterminantM2(Matrix);
 ...
 COVERAGE(HMM_M3, 1)
  inline_function HMM_Mat3 HMM_M3(void)
 {
 ...
 COVERAGE(HMM_M3D, 1)
  inline_function HMM_Mat3 HMM_M3D(f32 Diagonal)
 {
 ...
 COVERAGE(HMM_TransposeM3, 1)
  inline_function HMM_Mat3 HMM_TransposeM3(HMM_Mat3 Matrix)
 {
 ...
 COVERAGE(HMM_AddM3, 1)
  inline_function HMM_Mat3 HMM_AddM3(HMM_Mat3 Left, HMM_Mat3 Right)
 {
 ...
 COVERAGE(HMM_SubM3, 1)
  inline_function HMM_Mat3 HMM_SubM3(HMM_Mat3 Left, HMM_Mat3 Right)
 {
 ...
 COVERAGE(HMM_MulM3V3, 1)
  inline_function HMM_Vec3 HMM_MulM3V3(HMM_Mat3 Matrix, HMM_Vec3 Vector)
 {
 ...
 COVERAGE(HMM_MulM3, 1)
  inline_function HMM_Mat3 HMM_MulM3(HMM_Mat3 Left, HMM_Mat3 Right)
 {
 ...
 COVERAGE(HMM_MulM3F, 1)
  inline_function HMM_Mat3 HMM_MulM3F(HMM_Mat3 Matrix, f32 Scalar)
 {
 ...
 COVERAGE(HMM_DivM3, 1)
  inline_function HMM_Mat3 HMM_DivM3F(HMM_Mat3 Matrix, f32 Scalar)
 {
 ...
 COVERAGE(HMM_DeterminantM3, 1)
  inline_function f32 HMM_DeterminantM3(HMM_Mat3 Matrix)
 {
 ...
 COVERAGE(HMM_InvGeneralM3, 1)
  inline_function HMM_Mat3 HMM_InvGeneralM3(HMM_Mat3 Matrix)
 {
  ...
  f32 InvDeterminant = 1.0f / HMM_DotV3(Cross.Columns[2], Matrix.Columns[2]);
 ...
 // NOTE(gsp): @hmm_math added trace m3
 COVERAGE(HMM_TraceM3, 1)
  inline_function f32 HMM_TraceM3(HMM_Mat3 Matrix)
 {
  ASSERT_COVERED(HMM_TraceM3);
  
  f32 result = Matrix.Elements[0][0] + Matrix.Elements[1][1] + Matrix.Elements[2][2];
  return result;
 }
 ...
 COVERAGE(HMM_M4, 1)
  inline_function HMM_Mat4 HMM_M4(void)
 {
 ...
 COVERAGE(HMM_M4D, 1)
  inline_function HMM_Mat4 HMM_M4D(f32 Diagonal)
 {
 ...
 COVERAGE(HMM_TransposeM4, 1)
  inline_function HMM_Mat4 HMM_TransposeM4(HMM_Mat4 Matrix)
 {
 ...
 COVERAGE(HMM_AddM4, 1)
  inline_function HMM_Mat4 HMM_AddM4(HMM_Mat4 Left, HMM_Mat4 Right)
 {
 ...
 COVERAGE(HMM_SubM4, 1)
  inline_function HMM_Mat4 HMM_SubM4(HMM_Mat4 Left, HMM_Mat4 Right)
 {
 ...
 COVERAGE(HMM_MulM4, 1)
  inline_function HMM_Mat4 HMM_MulM4(HMM_Mat4 Left, HMM_Mat4 Right)
 {
 ...
 COVERAGE(HMM_MulM4F, 1)
  inline_function HMM_Mat4 HMM_MulM4F(HMM_Mat4 Matrix, f32 Scalar)
 {
 ...
 COVERAGE(HMM_MulM4V4, 1)
  inline_function HMM_Vec4 HMM_MulM4V4(HMM_Mat4 Matrix, HMM_Vec4 Vector)
 {
 ...
 COVERAGE(HMM_DivM4F, 1)
  inline_function HMM_Mat4 HMM_DivM4F(HMM_Mat4 Matrix, f32 Scalar)
 {
 ...
 COVERAGE(HMM_DeterminantM4, 1)
  inline_function f32 HMM_DeterminantM4(HMM_Mat4 Matrix)
 {
 ...
 COVERAGE(HMM_InvGeneralM4, 1)
  ...
  inline_function HMM_Mat4 HMM_InvGeneralM4(HMM_Mat4 Matrix)
 {
  ...
  f32 InvDeterminant = 1.0f / (HMM_DotV3(C01, B32) + HMM_DotV3(C23, B10));
 ...
 COVERAGE(HMM_Orthographic_RH_NO, 1)
  ...
  inline_function HMM_Mat4 HMM_Orthographic_RH_NO(f32 Left, f32 Right, f32 Bottom, f32 Top, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_Orthographic_RH_ZO, 1)
  ...
  // Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
  // Near and Far specify the distances to the near and far clipping planes.
  inline_function HMM_Mat4 HMM_Orthographic_RH_ZO(f32 Left, f32 Right, f32 Bottom, f32 Top, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_Orthographic_LH_NO, 1)
  ...
  // Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
  // Near and Far specify the distances to the near and far clipping planes.
  inline_function HMM_Mat4 HMM_Orthographic_LH_NO(f32 Left, f32 Right, f32 Bottom, f32 Top, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_Orthographic_LH_ZO, 1)
  ...
  // Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
  // Near and Far specify the distances to the near and far clipping planes.
  inline_function HMM_Mat4 HMM_Orthographic_LH_ZO(f32 Left, f32 Right, f32 Bottom, f32 Top, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_InvOrthographic, 1)
  ...
  inline_function HMM_Mat4 HMM_InvOrthographic(HMM_Mat4 OrthoMatrix)
 {
 ...
 COVERAGE(HMM_Perspective_RH_NO, 1)
  inline_function HMM_Mat4 HMM_Perspective_RH_NO(f32 FOV, f32 AspectRatio, f32 Near, f32 Far)
 {
  ...
  f32 Cotangent = 1.0f / HMM_TanF(FOV / 2.0f);
 ...
 COVERAGE(HMM_Perspective_RH_ZO, 1)
  inline_function HMM_Mat4 HMM_Perspective_RH_ZO(f32 FOV, f32 AspectRatio, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_Perspective_LH_NO, 1)
  inline_function HMM_Mat4 HMM_Perspective_LH_NO(f32 FOV, f32 AspectRatio, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_Perspective_LH_ZO, 1)
  inline_function HMM_Mat4 HMM_Perspective_LH_ZO(f32 FOV, f32 AspectRatio, f32 Near, f32 Far)
 {
 ...
 COVERAGE(HMM_InvPerspective_RH, 1)
  inline_function HMM_Mat4 HMM_InvPerspective_RH(HMM_Mat4 PerspectiveMatrix)
 {
 ...
 COVERAGE(HMM_InvPerspective_LH, 1)
  inline_function HMM_Mat4 HMM_InvPerspective_LH(HMM_Mat4 PerspectiveMatrix)
 {
 ...
 COVERAGE(HMM_Translate, 1)
  inline_function HMM_Mat4 HMM_Translate(HMM_Vec3 Translation)
 {
 ...
 COVERAGE(HMM_InvTranslate, 1)
  inline_function HMM_Mat4 HMM_InvTranslate(HMM_Mat4 TranslationMatrix)
 {
 ...
 COVERAGE(HMM_Rotate_RH, 1)
  inline_function HMM_Mat4 HMM_Rotate_RH(f32 Angle, HMM_Vec3 Axis)
 {
  ...
  f32 SinTheta = HMM_SinF(Angle);
  f32 CosTheta = HMM_CosF(Angle);
 ...
 COVERAGE(HMM_Rotate_LH, 1)
  inline_function HMM_Mat4 HMM_Rotate_LH(f32 Angle, HMM_Vec3 Axis)
 {
 ...
 COVERAGE(HMM_InvRotate, 1)
  inline_function HMM_Mat4 HMM_InvRotate(HMM_Mat4 RotationMatrix)
 {
 ...
 COVERAGE(HMM_Scale, 1)
  inline_function HMM_Mat4 HMM_Scale(HMM_Vec3 Scale)
 {
 ...
 COVERAGE(HMM_InvScale, 1)
  inline_function HMM_Mat4 HMM_InvScale(HMM_Mat4 ScaleMatrix)
 {
 ...
 inline_function HMM_Mat4 _HMM_LookAt(HMM_Vec3 F,  HMM_Vec3 S, HMM_Vec3 U,  HMM_Vec3 Eye)
 {
  HMM_Mat4 Result;
 ...
 COVERAGE(HMM_LookAt_RH, 1)
  inline_function HMM_Mat4 HMM_LookAt_RH(HMM_Vec3 Eye, HMM_Vec3 Center, HMM_Vec3 Up)
 {
 ...
 COVERAGE(HMM_LookAt_LH, 1)
  inline_function HMM_Mat4 HMM_LookAt_LH(HMM_Vec3 Eye, HMM_Vec3 Center, HMM_Vec3 Up)
 {
 ...
 COVERAGE(HMM_InvLookAt, 1)
  inline_function HMM_Mat4 HMM_InvLookAt(HMM_Mat4 Matrix)
 {
 ...
 COVERAGE(HMM_Q, 1)
  inline_function HMM_Quat HMM_Q(f32 X, f32 Y, f32 Z, f32 W)
 {
 ...
 COVERAGE(HMM_QV4, 1)
  inline_function HMM_Quat HMM_QV4(HMM_Vec4 Vector)
 {
 ...
 COVERAGE(HMM_AddQ, 1)
  inline_function HMM_Quat HMM_AddQ(HMM_Quat Left, HMM_Quat Right)
 {
 ...
 COVERAGE(HMM_SubQ, 1)
  inline_function HMM_Quat HMM_SubQ(HMM_Quat Left, HMM_Quat Right)
 {
 ...
 COVERAGE(HMM_MulQ, 1)
  inline_function HMM_Quat HMM_MulQ(HMM_Quat Left, HMM_Quat Right)
 {
...
#elif defined(HANDMADE_MATH__USE_NEON)
  f3232x4_t Right1032 = vrev64q_f32(Right.NEON);
  f3232x4_t Right3210 = vcombine_f32(vget_high_f32(Right1032), vget_low_f32(Right1032));
  f3232x4_t Right2301 = vrev64q_f32(Right3210);
 ...
 COVERAGE(HMM_MulQF, 1)
  inline_function HMM_Quat HMM_MulQF(HMM_Quat Left, f32 Multiplicative)
 {
 ...
 COVERAGE(HMM_DivQF, 1)
  inline_function HMM_Quat HMM_DivQF(HMM_Quat Left, f32 Divnd)
 {
 ...
 COVERAGE(HMM_DotQ, 1)
  inline_function f32 HMM_DotQ(HMM_Quat Left, HMM_Quat Right)
 {
 ...
 COVERAGE(HMM_InvQ, 1)
  inline_function HMM_Quat HMM_InvQ(HMM_Quat Left)
 {
 ...
 COVERAGE(HMM_NormQ, 1)
  inline_function HMM_Quat HMM_NormQ(HMM_Quat Quat)
 {
 ...
 inline_function HMM_Quat _HMM_MixQ(HMM_Quat Left, f32 MixLeft, HMM_Quat Right, f32 MixRight) {
  HMM_Quat Result;
...
#elif defined(HANDMADE_MATH__USE_NEON)
  f3232x4_t ScaledLeft = vmulq_n_f32(Left.NEON, MixLeft);
  f3232x4_t ScaledRight = vmulq_n_f32(Right.NEON, MixRight);
 ...
 COVERAGE(HMM_NLerp, 1)
  inline_function HMM_Quat HMM_NLerp(HMM_Quat Left, f32 Time, HMM_Quat Right)
 {
 ...
 COVERAGE(HMM_SLerp, 1)
  inline_function HMM_Quat HMM_SLerp(HMM_Quat Left, f32 Time, HMM_Quat Right)
 {
  ASSERT_COVERED(HMM_SLerp);
  
  HMM_Quat Result;
  
  f32 Cos_Theta = HMM_DotQ(Left, Right);
  ...
  if (Cos_Theta > 0.9995f) {
   ...
   f32 Angle = HMM_ACosF(Cos_Theta);
   f32 MixLeft = HMM_SinF((1.0f - Time) * Angle);
   f32 MixRight = HMM_SinF(Time * Angle);
 ...
 COVERAGE(HMM_QToM4, 1)
  inline_function HMM_Mat4 HMM_QToM4(HMM_Quat Left)
 {
 ...
 COVERAGE(HMM_M4ToQ_RH, 4)
  inline_function HMM_Quat HMM_M4ToQ_RH(HMM_Mat4 M)
 {
  f32 T;
  HMM_Quat Q;
 ...
 COVERAGE(HMM_M4ToQ_LH, 4)
  inline_function HMM_Quat HMM_M4ToQ_LH(HMM_Mat4 M)
 {
  f32 T;
  HMM_Quat Q;
 ...
 COVERAGE(HMM_QFromAxisAngle_RH, 1)
  inline_function HMM_Quat HMM_QFromAxisAngle_RH(HMM_Vec3 Axis, f32 Angle)
 {
  ...
  f32 SineOfRotation = HMM_SinF(Angle / 2.0f);
 ...
 COVERAGE(HMM_QFromAxisAngle_LH, 1)
  inline_function HMM_Quat HMM_QFromAxisAngle_LH(HMM_Vec3 Axis, f32 Angle)
 {
 ...
 COVERAGE(HMM_RotateV2, 1)
  inline_function HMM_Vec2 HMM_RotateV2(HMM_Vec2 V, f32 Angle)
 {
  ASSERT_COVERED(HMM_RotateV2)
   
   f32 sinA = HMM_SinF(Angle);
  f32 cosA = HMM_CosF(Angle);
 ...
 COVERAGE(HMM_RotateV3Q, 1)
  inline_function HMM_Vec3 HMM_RotateV3Q(HMM_Vec3 V, HMM_Quat Q)
 {
 ...
 COVERAGE(HMM_RotateV3AxisAngle_LH, 1)
  inline_function HMM_Vec3 HMM_RotateV3AxisAngle_LH(HMM_Vec3 V, HMM_Vec3 Axis, f32 Angle) {
 ...
 COVERAGE(HMM_RotateV3AxisAngle_RH, 1)
  inline_function HMM_Vec3 HMM_RotateV3AxisAngle_RH(HMM_Vec3 V, HMM_Vec3 Axis, f32 Angle) {
...
inline_function f32 HMM_Len(HMM_Vec2 A)
{
...
inline_function f32 HMM_Len(HMM_Vec3 A)
{
...
inline_function f32 HMM_Len(HMM_Vec4 A)
{
...
inline_function f32 HMM_LenSqr(HMM_Vec2 A)
{
...
inline_function f32 HMM_LenSqr(HMM_Vec3 A)
{
...
inline_function f32 HMM_LenSqr(HMM_Vec4 A)
{
...
inline_function HMM_Vec2 HMM_Norm(HMM_Vec2 A)
{
...
inline_function HMM_Vec3 HMM_Norm(HMM_Vec3 A)
{
...
inline_function HMM_Vec4 HMM_Norm(HMM_Vec4 A)
{
...
inline_function HMM_Quat HMM_Norm(HMM_Quat A)
{
...
inline_function f32 HMM_Dot(HMM_Vec2 Left, HMM_Vec2 VecTwo)
{
...
inline_function f32 HMM_Dot(HMM_Vec3 Left, HMM_Vec3 VecTwo)
{
...
inline_function f32 HMM_Dot(HMM_Vec4 Left, HMM_Vec4 VecTwo)
{
...
inline_function HMM_Vec2 HMM_Lerp(HMM_Vec2 Left, f32 Time, HMM_Vec2 Right)
{
...
inline_function HMM_Vec3 HMM_Lerp(HMM_Vec3 Left, f32 Time, HMM_Vec3 Right)
{
...
inline_function HMM_Vec4 HMM_Lerp(HMM_Vec4 Left, f32 Time, HMM_Vec4 Right)
{
...
inline_function HMM_Mat2 HMM_Transpose(HMM_Mat2 Matrix)
{
...
inline_function HMM_Mat3 HMM_Transpose(HMM_Mat3 Matrix)
{
...
inline_function HMM_Mat4 HMM_Transpose(HMM_Mat4 Matrix)
{
...
inline_function f32 HMM_Determinant(HMM_Mat2 Matrix)
{
...
inline_function f32 HMM_Determinant(HMM_Mat3 Matrix)
{
...
inline_function f32 HMM_Determinant(HMM_Mat4 Matrix)
{
...
inline_function HMM_Mat2 HMM_InvGeneral(HMM_Mat2 Matrix)
{
...
inline_function HMM_Mat3 HMM_InvGeneral(HMM_Mat3 Matrix)
{
...
inline_function HMM_Mat4 HMM_InvGeneral(HMM_Mat4 Matrix)
{
...
inline_function f32 HMM_Dot(HMM_Quat QuatOne, HMM_Quat QuatTwo)
{
...
inline_function HMM_Vec2 HMM_Add(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Vec3 HMM_Add(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Vec4 HMM_Add(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Mat2 HMM_Add(HMM_Mat2 Left, HMM_Mat2 Right)
{
...
inline_function HMM_Mat3 HMM_Add(HMM_Mat3 Left, HMM_Mat3 Right)
{
...
inline_function HMM_Mat4 HMM_Add(HMM_Mat4 Left, HMM_Mat4 Right)
{
...
inline_function HMM_Quat HMM_Add(HMM_Quat Left, HMM_Quat Right)
{
...
inline_function HMM_Vec2 HMM_Sub(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Vec3 HMM_Sub(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Vec4 HMM_Sub(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Mat2 HMM_Sub(HMM_Mat2 Left, HMM_Mat2 Right)
{
...
inline_function HMM_Mat3 HMM_Sub(HMM_Mat3 Left, HMM_Mat3 Right)
{
...
inline_function HMM_Mat4 HMM_Sub(HMM_Mat4 Left, HMM_Mat4 Right)
{
...
inline_function HMM_Quat HMM_Sub(HMM_Quat Left, HMM_Quat Right)
{
...
inline_function HMM_Vec2 HMM_Mul(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Vec2 HMM_Mul(HMM_Vec2 Left, f32 Right)
{
...
inline_function HMM_Vec3 HMM_Mul(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Vec3 HMM_Mul(HMM_Vec3 Left, f32 Right)
{
...
inline_function HMM_Vec4 HMM_Mul(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Vec4 HMM_Mul(HMM_Vec4 Left, f32 Right)
{
...
inline_function HMM_Mat2 HMM_Mul(HMM_Mat2 Left, HMM_Mat2 Right)
{
...
inline_function HMM_Mat3 HMM_Mul(HMM_Mat3 Left, HMM_Mat3 Right)
{
...
inline_function HMM_Mat4 HMM_Mul(HMM_Mat4 Left, HMM_Mat4 Right)
{
...
inline_function HMM_Mat2 HMM_Mul(HMM_Mat2 Left, f32 Right)
{
...
inline_function HMM_Mat3 HMM_Mul(HMM_Mat3 Left, f32 Right)
{
...
inline_function HMM_Mat4 HMM_Mul(HMM_Mat4 Left, f32 Right)
{
...
inline_function HMM_Vec2 HMM_Mul(HMM_Mat2 Matrix, HMM_Vec2 Vector)
{
...
inline_function HMM_Vec3 HMM_Mul(HMM_Mat3 Matrix, HMM_Vec3 Vector)
{
...
inline_function HMM_Vec4 HMM_Mul(HMM_Mat4 Matrix, HMM_Vec4 Vector)
{
...
inline_function HMM_Quat HMM_Mul(HMM_Quat Left, HMM_Quat Right)
{
...
inline_function HMM_Quat HMM_Mul(HMM_Quat Left, f32 Right)
{
...
inline_function HMM_Vec2 HMM_Div(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Vec2 HMM_Div(HMM_Vec2 Left, f32 Right)
{
...
inline_function HMM_Vec3 HMM_Div(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Vec3 HMM_Div(HMM_Vec3 Left, f32 Right)
{
...
inline_function HMM_Vec4 HMM_Div(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Vec4 HMM_Div(HMM_Vec4 Left, f32 Right)
{
...
inline_function HMM_Mat2 HMM_Div(HMM_Mat2 Left, f32 Right)
{
...
inline_function HMM_Mat3 HMM_Div(HMM_Mat3 Left, f32 Right)
{
...
inline_function HMM_Mat4 HMM_Div(HMM_Mat4 Left, f32 Right)
{
...
inline_function HMM_Quat HMM_Div(HMM_Quat Left, f32 Right)
{
...
inline_function HMM_Bool HMM_Eq(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Bool HMM_Eq(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Bool HMM_Eq(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Vec2 operator+(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Vec3 operator+(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Vec4 operator+(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Mat2 operator+(HMM_Mat2 Left, HMM_Mat2 Right)
{
...
inline_function HMM_Mat3 operator+(HMM_Mat3 Left, HMM_Mat3 Right)
{
...
inline_function HMM_Mat4 operator+(HMM_Mat4 Left, HMM_Mat4 Right)
{
...
inline_function HMM_Quat operator+(HMM_Quat Left, HMM_Quat Right)
{
...
inline_function HMM_Vec2 operator*(HMM_Vec2 Left, f32 Right)
{
...
inline_function HMM_Vec3 operator*(HMM_Vec3 Left, f32 Right)
{
...
inline_function HMM_Vec4 operator*(HMM_Vec4 Left, f32 Right)
{
...
inline_function HMM_Mat2 operator*(HMM_Mat2 Left, f32 Right)
{
...
inline_function HMM_Mat3 operator*(HMM_Mat3 Left, f32 Right)
{
...
inline_function HMM_Mat4 operator*(HMM_Mat4 Left, f32 Right)
{
...
inline_function HMM_Quat operator*(HMM_Quat Left, f32 Right)
{
...
inline_function HMM_Vec2 operator*(f32 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Vec3 operator*(f32 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Vec4 operator*(f32 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Mat2 operator*(f32 Left, HMM_Mat2 Right)
{
...
inline_function HMM_Mat3 operator*(f32 Left, HMM_Mat3 Right)
{
...
inline_function HMM_Mat4 operator*(f32 Left, HMM_Mat4 Right)
{
...
inline_function HMM_Quat operator*(f32 Left, HMM_Quat Right)
{
...
inline_function HMM_Vec2 operator*(HMM_Mat2 Matrix, HMM_Vec2 Vector)
{
...
inline_function HMM_Vec3 operator*(HMM_Mat3 Matrix, HMM_Vec3 Vector)
{
...
inline_function HMM_Vec4 operator*(HMM_Mat4 Matrix, HMM_Vec4 Vector)
{
...
inline_function HMM_Bool operator==(HMM_Vec2 Left, HMM_Vec2 Right)
{
...
inline_function HMM_Bool operator==(HMM_Vec3 Left, HMM_Vec3 Right)
{
...
inline_function HMM_Bool operator==(HMM_Vec4 Left, HMM_Vec4 Right)
{
...
inline_function HMM_Vec2 operator-(HMM_Vec2 In)
{
...
inline_function HMM_Vec3 operator-(HMM_Vec3 In)
{
...
inline_function HMM_Vec4 operator-(HMM_Vec4 In)
{
