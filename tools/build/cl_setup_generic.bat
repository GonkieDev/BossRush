...
SET VC_PATH=C:\Program Files (x86)\Microsoft Visual Studio\2019
IF NOT DEFINED LIB (IF EXIST "%VC_PATH%" (call "%VC_PATH%\BuildTools\VC\Auxiliary\Build\vcvarsall.bat" %1))

SET VC_PATH=C:\Users\Gonk\GONK_DEV\BuildTools
IF NOT DEFINED LIB (IF EXIST "%VC_PATH%" (call "%VC_PATH%\devcmd.bat" %1))